...
export default function DramaBoxDetailPage() {
  ...
  const { data: episodes, isLoading: epLoading } = useEpisodes(bookId || "");

  if (isLoading || epLoading) {
    // show skeleton while either detail or episodes are loading
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[300px_1fr] gap-8">
            ...
            <div className="space-y-6">
              ...
              {/* Episode list (click to jump directly) */}
                ...
                <div className="mt-6">
                  ...
                  <div className="grid grid-cols-5 gap-2">
                    {episodes.map((ep: Episode, idx: number) => (
                      <Link
                        key={ep.chapterId}
                        href={`/watch/dramabox/${book.bookId}?ep=${idx}`}
